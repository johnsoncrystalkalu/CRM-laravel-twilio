...
<html lang="en">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('admin.users.edit', Auth::user()->id) }}">Settings</a></li>
    ...
    @include('admin.components.notice_modal')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if(sessionModal) {
        const modal = new bootstrap.Modal(sessionModal);
        modal.show();
    }
});
</script>
